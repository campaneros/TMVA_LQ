...
output = TFile.Open('TMVA_BDT_noweight_numev.root', 'RECREATE')
        ...
        #    print("Current Ngen: "+str(thisNgen))
         ...
         #   print("Total number of selected events: "+str(entries))
            ...
            if 'LQ' in sample:
                ...
                dataloader.AddSignalTree(signal['%s'%sample], weight)
                #dataloader.SetSignalWeightExpression("weight_PU*weight_Generator*Muon1_weight_all*Muon1_weight_Trigger")
                ...
                #dataloader.SetBackgroundWeightExpression("weight_PU*weight_Generator*Muon1_weight_all*Muon1_weight_Trigger")
...
roc.SaveAs('ROC_ClassificationPyTorch_BDT_numev.png')
