        ...
        #    print("Current Ngen: "+str(thisNgen))
         ...
         #   print("Total number of selected events: "+str(entries))
            ...
            if 'LQ' in sample:
                ...
                dfs['%s'%sample]=dfs['%s'%sample].Define("weight_all_1muon","float(weight_PU*weight_Generator*Muon1_weight_all*Muon1_weight_Trigger*{})".format(weight))
                dfs['%s'%sample]=dfs['%s'%sample].Define("weight_all_2muon","float(weight_PU*weight_Generator*Muon1_weight_all*Muon1_weight_Trigger*{})".format(weight))
                ...
                dfs['%s'%sample]=dfs['%s'%sample].Define("cross_section","float({})".format(float(xsec)))
                dfs['%s'%sample]=dfs['%s'%sample].Define("kfactor","float({})".format(float(kfac)))
                dfs['%s'%sample]=dfs['%s'%sample].Define("ngen_weight","float({})".format(float(ngen)))
                dfs['%s'%sample]=dfs['%s'%sample].Define("ngen","float({})".format(float(realngen)))
                dfs_1muon['%s'%sample]=dfs['%s'%sample].Filter("passNoiseFilters==1 && PassJSON==1 && passHLTMuon==1 && fabs(Muon1_Eta)<2.4 && Muon1_Pt>55 && AK4Jet1_Pt>90 && Muon1_Pt/AK4Jet1_Pt>0.6 && Muon1_Pt/AK4Jet1_Pt<1.6 && dPhi_muj_ak4>2.5 && met/sqrt(sumEt)<10&&nEleIdIso==0&&nMuonId==1").Snapshot(treeName,opt.outputdir+'/'+'%s_1_muon_dataset.root'%sample)
                dfs_2muon['%s'%sample]=dfs['%s'%sample].Filter("passNoiseFilters==1 && PassJSON==1 && passHLTMuon==1 && fabs(Muon1_Eta)<2.4 && Muon1_Pt>55 && AK4Jet1_Pt>90 && Muon1_Pt/AK4Jet1_Pt>0.6 && Muon1_Pt/AK4Jet1_Pt<1.6 && dPhi_muj_ak4>2.5 && met/sqrt(sumEt)<10&&nEleIdIso==0&&nMuonId==2&&Muon2_TrkIso<0.1&&sqrt((Muon1_Phi-Muon2_Phi)*(Muon1_Phi-Muon2_Phi)+(Muon1_Eta-Muon2_Eta)*(Muon1_Eta-Muon2_Eta))>0.1&&m_mumu>110").Snapshot(treeName,opt.outputdir+'/'+'%s_2_muon_dataset.root'%sample)
                ...
                if (int(0.2/weight_real)<=1):
                	...
                	dfb['%s'%sample]=dfb['%s'%sample].Define("cross_section","float({})".format(float(xsec)))
                	dfb['%s'%sample]=dfb['%s'%sample].Define("kfactor","float({})".format(float(kfac)))
                	dfb['%s'%sample]=dfb['%s'%sample].Define("ngen_weight","float({})".format(float(ngen)))
                	dfb['%s'%sample]=dfb['%s'%sample].Define("ngen","float({})".format(float(realngen)))
                	if 'WJets' in sample:
                		dfb_1muon['%s'%sample]=dfb['%s'%sample].Filter("LHE_Vpt>=100 && passNoiseFilters==1 && PassJSON==1 && passHLTMuon==1 && fabs(Muon1_Eta)<2.4 && Muon1_Pt>55 && AK4Jet1_Pt>90 && Muon1_Pt/AK4Jet1_Pt>0.6 && Muon1_Pt/AK4Jet1_Pt<1.6 && dPhi_muj_ak4>2.5 && met/sqrt(sumEt)<10&&nEleIdIso==0&&nMuonId==1")
                		dfb_2muon['%s'%sample]=dfb['%s'%sample].Filter("LHE_Vpt>=100 && passNoiseFilters==1 && PassJSON==1 && passHLTMuon==1 && fabs(Muon1_Eta)<2.4 && Muon1_Pt>55 && AK4Jet1_Pt>90 && Muon1_Pt/AK4Jet1_Pt>0.6 && Muon1_Pt/AK4Jet1_Pt<1.6 && dPhi_muj_ak4>2.5 && met/sqrt(sumEt)<10&&nEleIdIso==0&&nMuonId==2&&Muon2_TrkIso<0.1&&sqrt((Muon1_Phi-Muon2_Phi)*(Muon1_Phi-Muon2_Phi)+(Muon1_Eta-Muon2_Eta)*(Muon1_Eta-Muon2_Eta))>0.1&&m_mumu>110")
                	elif 'NLO' in sample:
                		dfb_1muon['%s'%sample]=dfb['%s'%sample].Filter("LHE_Vpt<100 && passNoiseFilters==1 && PassJSON==1 && passHLTMuon==1 && fabs(Muon1_Eta)<2.4 && Muon1_Pt>55 && AK4Jet1_Pt>90 && Muon1_Pt/AK4Jet1_Pt>0.6 && Muon1_Pt/AK4Jet1_Pt<1.6 && dPhi_muj_ak4>2.5 && met/sqrt(sumEt)<10&&nEleIdIso==0&&nMuonId==1")
                		dfb_2muon['%s'%sample]=dfb['%s'%sample].Filter("LHE_Vpt<100 && passNoiseFilters==1 && PassJSON==1 && passHLTMuon==1 && fabs(Muon1_Eta)<2.4 && Muon1_Pt>55 && AK4Jet1_Pt>90 && Muon1_Pt/AK4Jet1_Pt>0.6 && Muon1_Pt/AK4Jet1_Pt<1.6 && dPhi_muj_ak4>2.5 && met/sqrt(sumEt)<10&&nEleIdIso==0&&nMuonId==2&&Muon2_TrkIso<0.1&&sqrt((Muon1_Phi-Muon2_Phi)*(Muon1_Phi-Muon2_Phi)+(Muon1_Eta-Muon2_Eta)*(Muon1_Eta-Muon2_Eta))>0.1 &&m_mumu>110")
                	else:
                		dfb_1muon['%s'%sample]=dfb['%s'%sample].Filter("passNoiseFilters==1 && PassJSON==1 && passHLTMuon==1 && fabs(Muon1_Eta)<2.4 && Muon1_Pt>55 && AK4Jet1_Pt>90 && Muon1_Pt/AK4Jet1_Pt>0.6 && Muon1_Pt/AK4Jet1_Pt<1.6 && dPhi_muj_ak4>2.5 && met/sqrt(sumEt)<10&&nEleIdIso==0&&nMuonId==1")
