...
dataloader.AddVariable('Muon2_Pt_over_m_muj_ak4')
dataloader.AddVariable('Muon1_Eta_m_Muon2_Eta')
...
factory.BookMethod(dataloader, TMVA.Types.kBDT, 'BDT',
		    #'!H:!V:NTrees=1000:MinNodeSize=5%:MaxDepth=3:BoostType=Grad:UseBaggedGrad=True:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=100:IgnoreNegWeightsInTraining')
		    '!H:!V:NTrees=1000:MinNodeSize=5%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20')
